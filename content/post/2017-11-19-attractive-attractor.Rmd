...
```{r Clifford, eval = FALSE, fig.cap = '**Figure 1.** *My first Clifford attractor.*'}
...
![**Figure 1.** *My first Clifford attractor.*](/img/attractor.png)
   
This is sweet, but something is missing... perhaps there are not enough points. Let's use 10,000,000!

```{r Clifford_black, eval = FALSE, fig.cap = '***Figure 2.*** *A nice-looking Clifford attractor.*'}
...
![***Figure 2.*** *A nice-looking Clifford attractor.*](/img/attractor_black.png)
   
That's more like it. Now let's make another attractor, using 10,000,000 magenta points.

```{r Clifford_magenta, eval = FALSE, fig.cap = '***Figure 3.*** *A magenta Clifford attractor.*'}
...
![***Figure 3.*** *A magenta Clifford attractor.*](/img/attractor_mag.png)

Oh yeah, that's juicy[^2].   
   
I've got an idea: let's make a few more, and then overlay them!

```{r Clifford_overlay, eval = FALSE, fig.cap = '***Figure 4.*** *Black, magenta, blue, and golden Clifford attractors!*'}
...
![***Figure 4.*** *Black, magenta, blue, and golden Clifford attractors.*](/img/overlay.png)
...
```{r Clifford_code, eval = FALSE, echo = TRUE}
